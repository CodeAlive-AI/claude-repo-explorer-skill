# claude-repo-explorer-skill — moved
...
The repo-explorer skill now lives at:

→ **[ai-driven-development/skills/repo-explorer](https://github.com/CodeAlive-AI/ai-driven-development/tree/main/skills/repo-explorer)**

## Install (new location)

```bash
# Install just this skill
npx skills add CodeAlive-AI/ai-driven-development --skill repo-explorer
